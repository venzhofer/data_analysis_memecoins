...
class LiveTradingPatternDetector:
        ...
        try:
            ...
            if 'transactions' in data_point:
                ...
                if 'h6' in transactions:
                    ...
                    metrics['h6_buy_ratio'] = metrics['h6_buys'] / max(metrics['h6_buys'], 1)
            ...
            if 'volume' in data_point:
                ...
                metrics['h24_volume'] = volume.get('h24', 0)
    ...
    def detect_bearish_breakdown(self, metrics):
        ...
        try:
            conditions_met = (
                metrics.get('h24_volume', 0) < self.bearish_breakdown_thresholds['volume_h24'] and
    ...
    def detect_bearish_momentum(self, metrics):
        ...
        try:
            conditions_met = (
                metrics.get('h24_volume', 0) < self.bearish_momentum_thresholds['volume_h24'] and
    ...
    def detect_bullish_momentum(self, metrics):
        ...
        try:
            conditions_met = (
                metrics.get('h24_volume', 0) > self.bullish_momentum_thresholds['volume_h24'] and
    ...
    def detect_bullish_breakout(self, metrics):
        ...
        try:
            conditions_met = (
                metrics.get('h24_volume', 0) > self.bullish_breakout_thresholds['volume_h24'] and
