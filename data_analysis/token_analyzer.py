...
class TokenAnalyzer:
    ...
    def fetch_tokens_info(self) -> Dict:
        """Fetch basic information about all tokens"""
        try:
            print("Fetching tokens information...")
    ...
    def run_analysis(self, max_tokens: int = 100) -> Dict:
        ...
        # Limit analysis to max_tokens to avoid overwhelming the API
    ...
    def create_visualizations(self, results: Dict):
        ...
        fig.suptitle('Token Performance Analysis', fontsize=16, fontweight='bold')
        ...
        if "categorized" in results["summary"]:
            ...
            bars = axes[0, 1].bar(categories, percentages, color=['red', 'green', 'orange', 'blue'])
        ...
        if results["detailed_results"]:
            ...
            if changes:
                axes[1, 0].hist(changes, bins=30, alpha=0.7, color='skyblue', edgecolor='black')
...
def main():
    ...
    # Run the analysis
    results = analyzer.run_analysis(max_tokens=50)  # Limit to 50 tokens for initial run
