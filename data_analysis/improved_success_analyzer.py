#!/usr/bin/env python3
"""
IMPROVED Success/Failure Condition Analyzer
Analyzes actual token data with better pattern detection
"""
...
def create_success_condition_report(success_conditions):
    ...
    print("\n" + "=" * 80)
    print("🎯 IMPROVED SUCCESS/FAILURE CONDITION ANALYSIS REPORT")
    print("=" * 80)
...
def main():
    print("🚀 IMPROVED SUCCESS/FAILURE CONDITION ANALYSIS")
    print("=" * 60)
    ...
    # Analyze each token (start with first 3 for better results)
